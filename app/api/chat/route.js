...
11. 주인공의 3지선다 선택지: <!-- SUGGESTIONS: ["선택지 1", "선택지 2", "선택지 3"] -->`;
      ...
      let rulePrompt = "";
        if (ruleMode === "coc") {
          // 👇 여기서부터 아래 내용을 덮어써 주세요!
          rulePrompt = `[크툴루의 부름 7판 CoC 진행 수칙 - 🚨 판정 강제 연동]
1. [행동 판정 엄수]: 플레이어가 지문을 통해 행동(예: 문을 연다, 주변을 살핀다, 상대를 설득한다, 회피한다 등)을 선언하는 즉시, AI는 결과(성공/실패)를 마음대로 서술해서는 절대 안 됩니다!
2. [결과 묘사 금지 및 주사위 요구]: 플레이어의 선언에 대한 긴장감 넘치는 반응까지만 서술한 뒤, 문단을 마무리하고 지문 맨 끝에 아래 태그를 '반드시' 출력하여 주사위 굴림을 유도하십시오.
   예시: <!-- CHECK: {"skill": "관찰력", "target": 50, "reason": "숨겨진 단서를 찾기 위해"} -->
   예시: <!-- CHECK: {"skill": "근력", "target": 40, "reason": "억지로 문을 열기 위해"} -->
3. [안내 문구 필수]: 태그 출력 후에는 반드시 "결과를 확인하려면 [관련 기능] 주사위를 굴려주세요."라고 명시하고 답변을 멈추십시오.
4. 물리적 탐색 구역 해금: <!-- SPOTS: [{"name": "오브젝트", "stat": "기능명"}] -->
5. 기괴한 현상이나 끔찍한 진실 목격 시 이성(SAN) 체크 강제: <!-- CHECK: {"skill": "이성", "target": ${playerSheet?.san || 50}, "reason": "충격적인 광경을 목격함"} -->
