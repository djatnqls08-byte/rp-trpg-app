...
const RULE_GUIDES = {
  coc: {
    ...
    system: "1D100 백분율 다이스로 판정하며, 자신의 능력치 이하가 나오면 성공합니다. 무시무시한 괴이를 목격할 때마다 깎여나가는 '이성치(SAN)'와 영구 광기 시스템이 백미입니다."
  },
  dnd: {
    title: "던전 앤 드래곤 (D&D 5판)",
    desc: "세계에서 가장 유명한 하이 판타지 모험 TRPG입니다. 검과 마법, 신비로운 던전 탐험과 괴물 토벌을 다룹니다.",
