...
export default function App() {
  ...
  const clichesPool = {
    coc: {
      names: [
        "사반", "로웨나", "비비안", "엘레노어", "카밀라", "샬롯", "이졸데", "마리안", 
        "세실리아", "베아트리스", "헬레나", "다프네", "클라우디아", "코델리아", "에블린",
        "베로니카", "아델라인", "플로렌스", "기네비어", "레오노라", "로잘린", "페넬로피"
      ],
      jobs: [
        ...
        { job: "오컬트 고서 번역가", item: "암호 해독 사전, 라틴어 필사본, 잉크병", bg: "금지된 밀교의 죽은 언어를 연구하며 현실과 환각의 경계에서 금기의 진실을 엿본 번역가." },
        ...
        { job: "퇴역 군 장교", item: "군용 트렌치 나이프, 베블리 리볼버, 야전 쌍안경", bg: "참호전의 참상 속에서 인간이 아닌 괴물들과 마주쳤던 트라우마를 안고 진실을 쫓는 참전용사." },
        { job: "전위 행위예술가", item: "스케치북, 차콜 목탄, 유화용 페인팅 나이프", bg: "광기와 광채가 교차하는 영감을 캔버스에 담아내며 이계의 풍경을 환시하는 화가." },
        { job: "밀주 밀수업자", item: "개조 렌치, 힙 플라스크, 놋쇠 너클", bg: "금주법 시대의 은밀한 밀주 유통로를 개척하다 버려진 터널 속에서 괴이한 사교 의식을 목격한 브로커." },
        { job: "교구 수녀", item: "은제 묵주, 성수병, 라틴어 기도서", bg: "수녀원의 굳게 닫힌 납골당에서 기어나오는 기괴한 속삭임에 맞서 신앙과 의구심 사이에서 고뇌하는 수도자." },
        { job: "서커스 마술사", item: "트릭용 플레잉 카드, 실크 와이어, 연막 캡슐", bg: "눈속임 마술의 정점에 섰으나 진짜로 물리법칙을 무시하는 오컬트적 초자연 현상에 휘말린 공연자." },
        { job: "비밀 결사 도주자", item: "의식용 단검, 상징 문양 팬던트, 방탄 코트", bg: "인간 제물을 바치는 비밀 사교 집단에서 도망쳐 나와 그들의 추적을 피하며 복수를 노리는 생존자." },
        { job: "약제사", item: "유발과 막자, 약초 가루 주머니, 유리 눈금 실린더", bg: "금지된 조제법으로 만든 영약으로 환자들의 악몽과 신체 변이를 지켜보며 배후를 캐는 약사." }
      ],
      places: [
...
반드시 아래 JSON 포맷으로만 응답하세요:
{
  ...
  const executeExport = () => {
    ...
    if (exportFormat === "md") {
      ...
      exportText += `- **규칙**: ${session.ruleMode === "coc" ? "크툴루의 부름 7판" : "자유 서사"}\n`;
            ...
            >
              <div style={{ overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", flex: 1, paddingRight: "6px" }}>
                ...
                <div style={{ fontSize: "0.72rem", color: theme.textMuted }}>
                  {s.ruleMode === "coc" ? "CoC 7판 정규" : "자유 서사"}
                </div>
              </div>
              <button
